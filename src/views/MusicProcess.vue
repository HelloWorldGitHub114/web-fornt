    ...
    <div class="musicprocess">
      ...
      <div class="audio-left">
        ...
        <div class="audio-btns">
          <a href="#" class="iconfont" @click="previous()">
            ⏮️
          </a>
          <!-- 播放 -->
          <a
          ...
          <!-- 下一首 -->
          <a href="#" class="iconfont" @click="next()">
            ⏯️
          </a>
        </div>
        <!-- 进度条 -->
        <div class="audio-progress">
          ...
          <div class="block">
            <el-slider v-model="currentTime" :max="duration" @change="onSliderChange" :format-tooltip="formatTooltipProgress"></el-slider>
          </div>
      ...
      <div class="audio-right">
        ...
        <div class="mode-volume-list">
          ...
          <a href="#" class="iconfont" v-if="!voice" @click="voice = cacheVoice == 0 ? 0.7 : cacheVoice">🔈</a>
          <!-- 音量控制面板 -->
